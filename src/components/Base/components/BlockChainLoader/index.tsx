...
export const BlockChainLoader: React.FunctionComponent<IProps> = ({ size = 'normal', color = '', ...props }) => (
  <div {...props}>
    <div className={cn(styles['sk-folding-cube'], styles[size], [styles[`sk-folding-cube_color_${color}`]])}>
